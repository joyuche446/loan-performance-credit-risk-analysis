...
## Project Overview:
This project analyzes loan performance and credit risk using a simulated real-world lending dataset to understand the loan portfolio health, borrower's behaviors and financial trends.
